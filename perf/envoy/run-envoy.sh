...
podman run --name=envoy --network=host -it -d -v ${SCRIPT_DIR}/envoy-dynamic.yaml:/envoy-dynamic.yaml:z  -v ${BASE_DIR}/testrun/:${BASE_DIR}/testrun/:Z,ro ${IMG}:${VER} -c /envoy-dynamic.yaml
