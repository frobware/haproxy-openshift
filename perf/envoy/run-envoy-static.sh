...
podman run --name=envoy --network=host -it -v ${SCRIPT_DIR}/envoy-static-example.yaml:/envoy-static.yaml:z  -v ${BASE_DIR}/testrun/:${BASE_DIR}/testrun/:Z,ro ${IMG}:${VER} -c /envoy-static.yaml
